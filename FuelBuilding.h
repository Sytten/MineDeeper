...
class FuelBuilding : public Building
{
    public:
        ...
        bool enter(sfg::SFGUI& sfgui, sf::RenderWindow& window, Character *ptrCharacter);
    ...
    private:
        ...
        // Slots
            void button5Click() { moneyButtonClick(5); }
            void button10Click() { moneyButtonClick(10); }
            void button25Click() { moneyButtonClick(25); }
            void button50Click() { moneyButtonClick(50); }
